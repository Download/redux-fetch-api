...
/***/ function(module, exports, __webpack_require__) {
	...
	describe('@remote(url=\'\', clientUrl=null, onClient=isOnClient())', function () {
		...
		it('works when used as a regular function', function () {
			var Test = (0, _reduxFetchApi2.default)(function Test() {
				_classCallCheck(this, Test);
			});
			var test = new Test();
			(0, _chai.expect)(test).to.have.a.property('fetch');
			(0, _chai.expect)(test.fetch).to.be.a('function');
			var Test2 = (0, _reduxFetchApi2.default)('/test')(function Test2() {
				_classCallCheck(this, Test2);
			});
			var test2 = new Test2();
			(0, _chai.expect)(test2).to.have.a.property('fetch');
			(0, _chai.expect)(test2.fetch).to.have.a.property('url');
			(0, _chai.expect)(test2.fetch.url).to.equal('/test');
		});
